...
<ul>
  ...
  <li class="dropdown">
    <a href="#">
      ...
      <div class="dropdown-content">
 <a href="approve.php" target="_blank"  onclick="toggleApprovedRecommendations()">Approved Recommendation</a>
      </div>
    </a>
  </li>
...
<li><a href="#">
<i class ="fas fa-user"></i>
    <span class="dropbtn">Register Admin</span>
    <div class="dropdown-content">
      <a href="admin.php"target="_blank">All Admin</a>
    </div>
  </div>
</a></i>
<div class="dropdown">
<li><a href="#">
<i class ="fas fa-user"></i>
 <span class="dropbtn">User Assignment</span>
  <div class="dropdown-content">
  <a href="#">Assign Village</a>
    <a href="#">Assign Cell</a>
    <a href="#">Assign Sector</a>
	</div></div>
</a></i>
<li><a href="" class="logout">
  <a href="adminlog.php"target="blanck page"><i class ="fas fa-sign-out-alt"></i>
